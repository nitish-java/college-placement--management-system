				...
				<div class="top-nav">
					...
					<ul class="nav1">
						<li class="hvr-sweep-to-bottom">
								<a href="../Homepage/index.php">JISCE<i>Goto Placement Homepage</i></a>
							</li>
						<li class="hvr-sweep-to-bottom">
	...
	<div class="mail">
		...
		<div class="container">
			<div class="map footer-middle wow bounceIn animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;">
				<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3673.7460955134584!2d88.44517707508983!3d22.959576179217898!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3a027730302f6e25%3A0xe50dfccae21e1fc!2sJIS%20College%20of%20Engineering!5e0!3m2!1sen!2sin!4v1781639354284!5m2!1sen!2sin" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>" width="600" height="450" frameborder="0" style="border:0" allowfullscreen></iframe>
			</div>
			<div class="mail-grids">
				<div class="col-md-6 mail-grid-left wow fadeInLeft animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;">
					<h3>Contact Us</h3>	
					<p></p>				
					<h4>JIS College Of Engineering </h4>
					<p>Kalyani  Nadia , West Bengal,
						<span></span>
						India IN-741 235
					</p>
					<h4>Get In Touch</h4>
					<p>Telephone: +91 033 2580 8640 /033 2580 8560
						<span>FAX: +91 830-1979790</span>
						E-mail: <a href="mailto:info@jiscollege.ac.in">info@jiscollege.ac.in</a>
					</p>
				</div>
		...
		<div class="footer">
			...
			<div class="container">
				...
				<div class="col-md-3 footer-middle wow bounceIn animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;">
					...
					<div class="address">
						<p>JISCE
							<span>Kalyani  Nadia , West Bengal, </span>
						</p>
					</div>
					<div class="phone">
						<p>1234567890</p>
				...
				<div class="col-md-3 footer-right  wow fadeInRight animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;">
					<h6 style="color: white">JIS College Of Engineering </h6>
					<h4>
		...
		<div class="copyright">
			...
			<div class="container">
				<div class="copyright-left wow fadeInLeft animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;">
					 <p>Copyright &copy; 2026 JISCE | Developed by
              <a href="http://znumerique.azurewebsites.net" target="_parent">Nitish Kumar</a>
				</div>
