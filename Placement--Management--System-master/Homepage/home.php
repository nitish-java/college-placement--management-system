        ...
        <nav id="mainNav" class="navbar navbar-default navbar-fixed-top" style="background:black">
            <div class="container-fluid">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand page-scroll" href="http://www.jisce.ac.in">JIS College Of Engineering</a>
                </div>
        ...
        <div class="footer">
			<div class="container">
				...
				<div class="col-md-3 get_in_touch ftr">
					...
					<p>Kalyani, Nadia, India</p>
					<p>033 2582 2138</p>
					<a href="mailto:info@jiscollege.ac.in">info@jiscollege.ac.in</a>
				</div>
